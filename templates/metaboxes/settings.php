        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                ...
                <small>
                    ...
                    <?php esc_html_e('Visit our Help Center to learn more about variables:', 'mollie-forms');?> <a target="_blank" href="https://support.wobbie.nl/article/36-welke-variabelen-kan-ik-gebruiken">support.wobbie.nl</a>
                </small>
            </td>
        </tr>
        <tr valign="top">

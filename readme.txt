...
* New: Integration with [RCUR](https://rcur.eu) to create subscriptions in RCUR instead of Mollie
* Fix: Only flush rewrite rules on activation or plugin update instead of on every request, reducing database writes on each page load
